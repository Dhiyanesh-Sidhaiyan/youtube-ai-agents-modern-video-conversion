...
class Scene5(Scene):
    def construct(self):
        ...
        # Title
        title = Text("Impact of AI on Software Development Jobs", font_size=40, color=BLUE, weight=BOLD).to_edge(UP, buff=0.5)
        ...
        result_text = Text("Developers adapt and innovate.", font_size=22, color=GREEN_B, weight=BOLD)
