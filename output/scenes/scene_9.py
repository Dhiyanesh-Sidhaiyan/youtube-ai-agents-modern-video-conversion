...
class Scene9(Scene):
    def construct(self):
        ...
        # Title
        title = Text("Adapting to Technological Advancements", font_size=40, color=BLUE, weight=BOLD).to_edge(UP, buff=0.5)
        ...
        example_text = Text(
            "Climbing 'Lifelong Learning' ladder",
        ...
        result_text = Text("Adapting to new tech", font_size=22, color=GREEN_B, weight=BOLD)
