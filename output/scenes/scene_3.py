...
class Scene3(Scene):
    def construct(self):
        ...
        # Title with emphasis
        title = Text("Structured vs. Object-Oriented Programming", font_size=40, color=BLUE, weight=BOLD).to_edge(UP, buff=0.5)
        ...
        left_header = Text("Structured Programming", font_size=28, color=RED_C, weight=BOLD)
        left_underline = Line(LEFT * 1.5, RIGHT * 1.5, color=RED_C, stroke_width=2)
        left_items = VGroup(
            Text("* Flowchart", font_size=20, color=WHITE),
            Text("* Linear Processes", font_size=20, color=WHITE),
            Text("* Clear Procedures", font_size=20, color=WHITE),
        ...
        right_header = Text("Object-Oriented Programmi", font_size=28, color=GREEN_C, weight=BOLD)
        right_underline = Line(LEFT * 1.5, RIGHT * 1.5, color=GREEN_C, stroke_width=2)
        right_items = VGroup(
            Text("* Classes", font_size=20, color=WHITE),
            Text("* Encapsulation", font_size=20, color=WHITE),
            Text("* C++", font_size=20, color=WHITE),
        ).arrange(DOWN, aligned_edge=LEFT, buff=0.2)
