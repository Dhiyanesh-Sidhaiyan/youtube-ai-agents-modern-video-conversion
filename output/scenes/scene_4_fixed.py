...
class Scene4(Scene):
    def construct(self):
        # Title with emphasis
        title = Text("Historical Computing Paradigms vs. LLMs", font_size=40, color=BLUE, weight=BOLD).to_edge(UP, buff=0.5)
        ...
        left_header = Text("Historical Computing Para", font_size=28, color=RED_C, weight=BOLD)
        left_underline = Line(LEFT * 1.5, RIGHT * 1.5, color=RED_C, stroke_width=2)
        left_items = VGroup(
            Text("* Punch Cards", font_size=20, color=WHITE),
            Text("* Assembly Language", font_size=20, color=WHITE),
            Text("* High-Level Programming Languag", font_size=20, color=WHITE),
        ...
        right_header = Text("Modern Computing Paradigm", font_size=28, color=GREEN_C, weight=BOLD)
        right_underline = Line(LEFT * 1.5, RIGHT * 1.5, color=GREEN_C, stroke_width=2)
        right_items = VGroup(
            Text("* Large Language Models (LLMs)", font_size=20, color=WHITE),
            Text("* AI-Driven Infrastructures", font_size=20, color=WHITE),
            Text("* Advanced Data Management Syste", font_size=20, color=WHITE),
        ).arrange(DOWN, aligned_edge=LEFT, buff=0.2)
