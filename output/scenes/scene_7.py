...
class Scene7(Scene):
    def construct(self):
        # Title
        title = Text("LLMs in Action: A Chatbot Example", font_size=40, color=BLUE, weight=BOLD).to_edge(UP, buff=0.5)
        ...
        example_text = Text(
            "User: Request refund for order #12345",
        ...
        result_text = Text("Bot: Refund processed. Confirmation sent", font_size=22, color=GREEN_B, weight=BOLD)
