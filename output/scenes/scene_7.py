...
class Scene7(Scene):
    def construct(self):
        ...
        # Title with emphasis
        title = Text("Monolithic Architectures vs. Microservices", font_size=40, color=BLUE, weight=BOLD).to_edge(UP, buff=0.5)
        ...
        left_header = Text("Monolith", font_size=28, color=RED_C, weight=BOLD)
        left_underline = Line(LEFT * 1.5, RIGHT * 1.5, color=RED_C, stroke_width=2)
        left_items = VGroup(
            Text("* Single large block", font_size=20, color=WHITE),
            Text("* Less flexible", font_size=20, color=WHITE),
            Text("* Harder to scale", font_size=20, color=WHITE),
        ...
        right_header = Text("Microservices", font_size=28, color=GREEN_C, weight=BOLD)
        right_underline = Line(LEFT * 1.5, RIGHT * 1.5, color=GREEN_C, stroke_width=2)
        right_items = VGroup(
            Text("* Several smaller blocks connect", font_size=20, color=WHITE),
            Text("* More flexible", font_size=20, color=WHITE),
            Text("* Easier to scale independently", font_size=20, color=WHITE),
        ).arrange(DOWN, aligned_edge=LEFT, buff=0.2)
